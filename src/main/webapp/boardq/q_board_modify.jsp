...
<body>
	...
	<div class="container">
		...
		<div class="layout">
			...
			<div class="list">
				<!-- 게시판 수정 -->
				<form action="BoardqModifyAction.bo" method="post" name="modifyform">
					...
					<table>
						...
						<tr>
							...
							<td><input name="q_subject" size="50" maxlength="100"
						...
						<tr>
							...
							<td><textarea name="q_content" cols="67" rows="15"><%=board.getQ_content()%></textarea>
							<script type="text/javascript">
